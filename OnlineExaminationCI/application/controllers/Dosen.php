...
class Dosen extends CI_Controller
{
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('nip', 'NIP', 'required|numeric|trim|min_length[2]|max_length[12]' . $u_nip);
		$this->form_validation->set_rules('nama_dosen', 'Nama Dosen', 'required|trim|min_length[2]|max_length[50]');
